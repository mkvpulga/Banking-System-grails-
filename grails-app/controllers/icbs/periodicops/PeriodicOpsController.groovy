           ...
           if (bankwideHoliday == true){
               ...
               for (bh in bhList){
                   ...
                   if (!bHoliday){
                    // release holds
                        ...
                        loanPeriodicOpsService.updatePastDueInterest(startOfDayDate, bh)
                   } 
               }
            ...
            for (branch in bl){
                ...
                if (notWeekend){
                    ...
                    // for weekend do this
                    loanPeriodicOpsService.updatePenalties(startOfDayDate, branch)  
                    loanPeriodicOpsService.updatePastDueInterest(startOfDayDate, branch)  
                }
