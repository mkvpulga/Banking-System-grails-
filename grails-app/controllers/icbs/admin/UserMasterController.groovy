...
class UserMasterController {
    ...
    def save(UserMaster userMasterInstance) {
        ...
        println("userMasterInstance.designation.id: "+userMasterInstance.designation.id)
        println("userMasterInstance.cash: "+userMasterInstance.cash)
        println("userMasterInstance.coci: "+userMasterInstance.coci)
