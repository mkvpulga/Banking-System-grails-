...
<html>
    <head>  
        ...
        <title>Deposit Checks and Other Cash Items (COCI)</title>
...
<!--                <div id= "addCustomerRelatedError" class="box-body">
            ...
            <g:form name="txnPaymentAdjustmentForm" action="saveDepositCOCItxn" 
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <select id="txnTemplate" name="txnTemplate" class="many-to-one form-control" >
                            ...
                            <g:each in="${icbs.admin.TxnTemplate.findAllByMemoTxnTypeAndTxnType(icbs.lov.MemoTxnType.read(1), icbs.lov.TxnType.read(67),[sort:"code", order:"asc"])}" var="txnTemplateInstance">
