...
<html>
                            ...
                            <table class="table table-bordered table-striped">
                                <legend class="section-header">Reversed Transaction Details</legend>
                                    <tr>
                                        ...
                                        <td>${reverseTransactionFileInstance?.id}</td>
                                    </tr>                                
                                    <tr>
    ...
    <script>
         function newasd(){
            var w = window.open("${g.createLink(controller: 'tellering', action: 'newTransactionReversalPrintValidation', params: [txnFile:reverseTransactionFileInstance.id])}",'_blank');
            w.print(); 
