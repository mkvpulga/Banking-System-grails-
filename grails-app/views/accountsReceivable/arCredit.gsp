...
<html>
    ...
    <body>
        <content tag="main-content">
            ...
            <div class="panel panel-default">
                <div class = "panel-heading">
                    ...
                    <div class="panel-body">
                        <g:form id="deposit" url="[resource:accountsReceivableInstance, action:'savecrDebit']" method="PUT" >
                            <fieldset class="form">
        ...
        <content tag="main-actions">
            <ul>
                <li><g:actionSubmit class="save" id="savecrDebit" name="savecrDebit" action="savecrDebit" value="${message(code: 'default.button.Save.label', default: 'Save')}" onclick="
