...
<div class="form-group fieldcontain ${hasErrors(bean: customerInstance, field: 'birthDate', 'has-error')} ">
	...
	<div class="col-sm-8">
            <g:customDatePicker id="birthDate" name="birthDate" value="${customerInstance?.birthDate}"class="form-control"  />
...
<div class="form-group fieldcontain ${hasErrors(bean: customerInstance, field: 'townBirthPlace', 'has-error')} ">
	<label class="control-label col-sm-4" for="townBirthPlace">
		<g:message code="customer.townBirthPlace.label" default="Birth Place" />
		<span class="required-indicator">*</span>
	</label>
	<div class="col-sm-8">
            <%-- <g:textField name="birthPlace" maxlength="50"  value="${customerInstance?.birthPlace}"class="form-control"/> --%>
            <g:select id="townBirthPlace" name="townBirthPlace.id" from="${icbs.lov.Town.findAllByStatus(true)}" noSelection="${['':'']}" optionKey="id" optionValue="description" value="${customerInstance?.townBirthPlace?.id}"class="form-control"/>  
            <g:hasErrors bean="${customerInstance}" field="townBirthPlace">
                <div class="controls">
                    <span class="help-block">
                        <g:eachError bean="${customerInstance}" field="townBirthPlace">
                            <g:message error="${it}" /><br/>
                        </g:eachError>
                    </span>
                </div>
