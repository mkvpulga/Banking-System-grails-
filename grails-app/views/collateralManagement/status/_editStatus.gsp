...
<div>
    ...
    <g:form name="update-status-form">
        ...
        <div class="form-group fieldcontain ${hasErrors(bean: collateralInstance, field: 'status', 'has-error')} ">
            ...
            <div class="col-sm-8">
                <g:select id="status" name="status.id" from="${LoanCollateralStatus.listOrderById(order: "asc")}" optionKey="id" optionValue="description" value="${collateralInstance?.status?.id}" class="form-control"/>
