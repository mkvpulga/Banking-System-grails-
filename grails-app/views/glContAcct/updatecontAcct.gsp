            ...
            alertify.confirm(AppTitle,'Are you sure you want to create this contigent account?',
                    function(){
                                $.ajax({
                                    ...
                                    url: "${createLink(controller:'GlContAcct', action:'updatecontAcctajax')}",
                                    success: function(){                  
...
<legend></legend>
<g:form id="myForm" name="myForm" controller="GlContAcct" action="viewdetails" params="['ids': ContigentAccountInstance?.id]"  method="post">
    <g:hiddenField id="id"  name="id" value="${ContigentAccountInstance?.id}"  />  
</g:form>   
<div class="form-group fieldcontain ${hasErrors(bean: customerInstance, field: 'customerCode1', 'has-error')} ">
            <label class="control-label col-sm-4" for="dosriCode">
             ...
             <g:hiddenField id="idcontigent"  name="idcontigent" value="${ContigentAccountInstance?.id}" />  
            <div class="col-sm-8">
                <g:select id="contigent" name="contigent" from="${icbs.lov.ContigentAccount.findAllByStatus(true)}" optionKey="id" optionValue ="description" value="${ContigentAccountInstance?.contigent?.id}" class="form-control" noSelection="['null': '']" />
...
<div class="form-group fieldcontain ${hasErrors(bean: customerInstance, field: 'sssNo', 'has-error')} ">
            <label class="control-label col-sm-4"for="sssNo">
             ...
             <div class="col-sm-8">
                <g:textField   name="creditAmt" id="creditAmt" onkeyup="formatCreditNumber();" maxlength="50" value="${ContigentAccountInstance.creditAmt}"  class="form-control"/>
...
<div class="form-group fieldcontain ${hasErrors(bean: customerInstance, field: 'sssNo', 'has-error')} ">
            <label class="control-label col-sm-4"for="sssNo">
             ...
             <div class="col-sm-8">
                <g:textField name="debitAmt" id="debitAmt" maxlength="50" onkeyup="formatDebitNumber();" value="${ContigentAccountInstance.debitAmt}" class="form-control"/>
                    <div class="controls">
...
<div class="form-group fieldcontain ${hasErrors(bean: customerInstance, field: 'birthDate', 'has-error')} ">
	...
	<div class="col-sm-8">
            <g:customDatePicker name="txnDate" value="${ContigentAccountInstance?.txnDate}"class="form-control"  />
                    <div class="controls">
