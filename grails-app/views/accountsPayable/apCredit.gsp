...
<html>
    ...
    <body>
            ...
            <div class="panel panel-default">
                <div class = "panel-heading">
                    ...
                    <div class="panel-body">
                        <g:form id="deposit" url="[resource:accountsPayableInstance, action:'saveapCredit']" method="PUT" >
                            <fieldset class="form">
        ...
        <content tag="main-actions">
            <ul>
                <li><g:actionSubmit class="save" id="saveapCredit" name="saveapCredit" action="saveapCredit" value="${message(code: 'default.button.Save.label', default: 'Save')}" onclick="
