	...
	<body>
		...
		<g:if test="${flash.message}">
            ...
            <div id="error-notification" class="box-body" style="display: none">
               ...
               <g:form name="myForm" id="myForm" url="[action:'voucherAddDetailsAction',controller:'GlBatch']">
                    <div>				
                        ...
                        <div id="interest-rate-form-group" class="fieldcontain form-group">
                            ...
                            <div class="col-sm-8">
                                <g:field type="text" name="check_no" id="check_no" value=""  required="" class="form-control"/>
                            </div>
                        </div>
                        ...
                        <div id="termOfLoan-form-group"  class="fieldcontain form-group">
                                ...
                                <div class="col-sm-8">
                                <g:field type="text" name="payee" value="" id="payee" required="" class="form-control"/>
                            </div>
                        </div>
                        ...
                        <div id="downPayment-form-group"  class="fieldcontain form-group">
                                ...
                                <div class="col-sm-8">
                                <g:field  type="text" name="approved_by" id="approved_by" value="" required=""  class="form-control"/>
                        ...
                        <div id="desiredMonthlyPayment-form-group"  class="fieldcontain form-group">
                                ...
                                <div class="col-sm-8">
                                <g:field type="text" name="received_by" id="received_by" value="" required="" class="form-control" />
                            </div>
                        </div>
        ...
        <content tag="main-actions">
            <ul>                    
               <!-- <li><a href="#" onClick="details.addInputs()">Add Voucher Details</a></li>-->
                ...
                <li><a href="#" onclick="SubmitFormNow();">Add Voucher Details</a></li>
