...
<g:hiddenField name="userBranchId" id="userBranchId" value="${icbs.admin.UserMaster.get(session.user_id).branch.id}" />
%{-- Batch ID --}%
...
<div class="fieldcontain form-group required">
    ...
    <div class="controls col-sm-8"  >
      	 <g:if test="${session["postedOnOff"]=="postedOn"}">  
           <g:customDatePicker id="valueDate" name ="valueDate" precision="day" class="form-control" value="" /> 
        </g:if>
        <g:else>
             <g:customDatePicker id="valueDate" name ="valueDate" precision="day" class="form-control" value="" />
        </g:else>  
