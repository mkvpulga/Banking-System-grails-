...
<div id="amount-form-group" class="form-group fieldcontain ${hasErrors(bean: loanDeductionSchemeInstance, field: 'amount', 'has-error')}">
	...
	<div class="col-sm-8">
		<g:field class="form-control truncated" name="amount" value="${fieldValue(bean: loanDeductionSchemeInstance, field: 'amount')}"/>
...
--%>
<g:hiddenField name="divisor" id="divisor" value="1" />
</div>
