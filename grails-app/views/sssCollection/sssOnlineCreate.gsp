...
<html>
    <head>  
        ...
        <title>SSS eCollection (Employer)</title>  
    </head>
    ...
    <body>
        ...
        <content tag="main-content">
            ...
            <g:form id="create" url="[action:'sssConfirmBillerRef',controller: 'SssCollection']" onsubmit="callLoadingDialog();" >  
                <div class="form-group">
                    <label class="control-label">Biller Reference Number<span class="required-indicator">*</span></label>
                    <div class="col-sm-6">
                        <g:textField id="ssstxnBillRef" name="ssstxnBillRef" required="" class="form-control"/>
                        <g:hiddenField name="wsdlMethod" id="wsdlMethod" value="loadEmployerStatus" />  
                    </div>  
                </div>
