        ...
        <g:javascript>
            ...
            <g:form id="create" url="[action:'saveIndividualPrnInquiry',controller: 'SssCollection']" onsubmit="callLoadingDialog();"  >  
                ...
                <div class="form-group">
                    ...
                    <g:hiddenField id="flexiFund" name="flexiFund" value="${flexiFund}" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <g:textField id="flexxx" name="flexxx" value="${flexiFund}" class="form-control truncated" disabled="disable" />
                    </div>  
                </div>
                <div class="form-group">
