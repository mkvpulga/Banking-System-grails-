...
<html>
	...
	<body>
        <content tag="main-content">   
            ...
            <g:form name="creditScoringProduct" id="creditScoringProduct" url="[action:'configSection',controller:'CreditScoring']">            	
            	<div class="row">
                    <div class="col-md-12">
                        <div class="col-md-2">
            ...
            <div class="table-responsive">
            	<table class="table table-hover table-condensed table-bordered table-striped">
                    ...
                    <tbody>
                    <g:each in="${creditScoringCodeList}" status="i" var="creditScoringCodeDescriptionInstance">
                        <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                            <td>${creditScoringCodeDescriptionInstance?.code}</td>
                            <td>${creditScoringCodeDescriptionInstance?.description}</td>
                            <td><g:formatDate format="MM/dd/yyyy" date="${creditScoringCodeDescriptionInstance?.dateCreated}"/></td>
                            <td>${creditScoringCodeDescriptionInstance?.createdBy?.username}</td>
                            <td><g:link class="btn btn-secondary" action="codeWithQuestionSectionDetails" id="${creditScoringCodeDescriptionInstance.id}">View Credit Scoring Item Details</g:link> </td>
                        </tr>
                    </g:each> 
                    </tbody>
		</table>
            ...
            <div class="pagination">
                    <g:paginate total="${creditScoringCodeListInstanceCount ?: 0}" params="${params}" />
            </div>
            </content>
