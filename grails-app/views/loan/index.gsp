		...
		<div id="list-loan" class="content scaffold-list" role="main">
			...
			<div class="table-responsive">
					...
					<tr>
						...
						<g:sortableColumn property="openingDate" title="${message(code: 'loan.openingDate.label', default: 'Opening Date')}" />
                                                ...
                                                <g:sortableColumn property="balanceAmount" title="${message(code: 'loan.status.label', default: 'Balance')}" />
				...
				<g:each in="${loanInstanceList}" status="i" var="loanInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate format="MM/dd/yyyy" date="${loanInstance.dateApproved}"/></td>
            ...
            <content tag="main-actions">
                <ul>          
                    ...
                    <g:else>
                        <g:if test="${module == 'loan'}">
                             <li><button disabled>New Account</button></li>
                     </g:if>
                        </g:else>
				</ul>
            </content>
