                            ...
                            <div class="section-container">
                                ...
                                <table class="table table-bordered table-striped">
                                    <tbody>
                                        ...
                                        <g:if test="${loanLedgerDetails?.othersDebit > 0}">
                                         <tr>
                                            <td style="font-weight:bold" width="30%">Others Debit</td>
                                            <td width="70%"><g:formatNumber format="###,###,##0.00" number="${loanLedgerDetails?.othersDebit}" /></td>
                                        </tr>
                                        </g:if>
                                        <g:if test="${loanLedgerDetails?.othersCredit > 0}">
                                         <tr>
                                            <td style="font-weight:bold" width="30%">Others Credit</td>
                                            <td width="70%"><g:formatNumber format="###,###,##0.00" number="${loanLedgerDetails?.othersCredit}" /></td>
                                        </tr>
                                        </g:if>
                                        <tr>
                    ...
                    function validateReverse(){
                        ...
                        if(reference == "" || reference == null || reference=="null"){
                            ...
                            alertify.confirm(AppTitle,"Are you sure you want to Reverse this Loan Payment?",
                                function(){
                                checkIfAllowed('LON02300', 'form#loanReverseForm', '', '');
