...
<table class="table table-bordered table-striped">
    ...
    <g:hiddenField name="forvalidateLoanApplicationId" id="forvalidateLoanApplicationId" value="${loanApplicationInstance?.id}" />
    <tr>
...
<g:else>
    ...
    <tr>
        ...
        <td width="70%"><span>${loanApplicationInstance?.accountOfficer?.name}</span></td>
    </tr>  
    <tr>
