                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                                <tr>
                                        ...
                                        <td><label>Savings Component</label></td>
                        ...
                        <tbody>
                                        ...
                                        <g:each var="sweepAccounts" in="${session["sweeplist"]}">
                                                <tr>
                                                        ...
                                                        <td><g:formatNumber format="###,###,##0.00" number="${sweepAccounts?.savingsComponent}"/></td>                                                
                                                          ...
                                                          <div class="modal-dialog">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div id="savingsComponen-percentage-form-group" class="fieldcontain form-group">
                                                                        <label class="control-label col-sm-4" style="color: gray;">Savings Component</span></label>
                                                                        <div class="col-sm-8"><g:field id="editsavingsComponent${i}" name="editsavingsComponent" value="${sweepAccounts?.savingsComponent}" required="" class="form-control truncated"/></div>
                                                                    </div>  
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="button" onClick="reloadPageAfterClick('${i}')" class="btn btn-danger" >Cancel</button>
                                                                ...
                                                                <g:javascript>
                                                                    ...
                                                                    function validateFields(xxx){
                                                                        ...
                                                                        var ssavingsComponent = $('#editsavingsComponent'+xxx).val();
                                                                        console.log("ssavingsComponent: "+ssavingsComponent);
                                                                        if(ssavingsComponent==""){
                                                                            ssavingsComponent = parseFloat(0.00);
                                                                        }else{
                                                                            ssavingsComponent = parseFloat($('#editsavingsComponent'+xxx).val().toString().replace(",","")); 
                                                                        }
                                                                        if(srule == 3){                
                                                                        ...
                                                                        if(isValidateAll == true){
                                                                            ...
                                                                            function(){
                                                                                var obj = { 
                                                                                    ...
                                                                                    ssavingsComponent: ssavingsComponent
                                                                                }; 
...
<div class="modal-dialog">
  ...
  <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div id="savingsComponen-percentage-form-group" class="fieldcontain form-group">
              <label class="control-label col-sm-4" style="color: gray;">Savings Component</span></label>
              <div class="col-sm-8"><g:field id="savingsComponent" name="savingsComponent" value="" required="" class="form-control truncated"/></div>
          </div>           
          <div class="fieldcontain form-group">
              <label class="control-label col-sm-4" style="color: gray;">Remarks <span class="required-indicator">*</span></label>
      ...
      <div class="modal-footer">
          ...
          <button type="button" onclick="reloadPageAfterClick('add');" class="btn btn-danger" data-dismiss="modal">Cancel</button>
      ...
      <g:javascript>
        ...
        function reloadPageAfterClick(action){
             if(action == 'add'){
                $('#addLoanSweepAccount').modal('hide');
             }else{
                $('#updateSweepModal'+action).modal('hide');
             }
        ...
        function updateSweepForm() {
          ...
          function createValidateFields(){
                ...
                var ssavingsComponent = $('#savingsComponent').val(); 
                ...
                if(ssavingsComponent == ""){
                    ssavingsComponent = parseFloat(0.00);
                    console.log("ssssavingsComponent: "+ssavingsComponent);
                }else{
                    ssavingsComponent = parseFloat(ssavingsComponent.toString().replace(",",""));
                }
                console.log("ssssavingsComponent: "+ssavingsComponent);
