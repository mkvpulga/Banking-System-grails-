...
<html>
	...
	<body>
        <content tag="breadcrumbs">
            <span class="fa fa-chevron-right"></span><span class="current">Renew Loan Account</span>
	</content>
		...
		<div id="edit-loan" class="content scaffold-edit" role="main">
			...
			<g:form id="loan-form" url="[resource:loanInstance, action:'saveNew']" onsubmit="callLoadingDialog();">
