...
action:'getSchemeDetailsAjax')}", 
    ...
    <content tag="main-content">
        <div id="edit-loan" class="content scaffold-edit" role="main">
            ...
            <g:form id="loan-form" url="[resource:loanInstance, action:'update']" method="PUT" onsubmit="callLoadingDialog();">
    ...
    <content tag="main-actions">
        <ul>
            <g:if test="${module == "loanAmendment"}">
                <li><g:submitButton id="save" name="save" value="Save" onclick="loanAmendmentOverride();"/></li>
                </g:if>
                <g:else>
            ...
            <script>
                ...
                function loanAmendmentOverride(){
                alertify.confirm(AppTitle,'Are you sure you want to Update this loan?',
                function(){
                // params: policyTemplate.code, form to be saved
                checkIfAllowed('LON00600', 'form#loan-form', 'Update branch XXX.', null);
                },
                function(){
                return;
                });                     
