...
<g:hiddenField id="customer" name="customer.id" value="${loanInstance?.customer?.id}" />
  <g:if test="${Institution.findByParamCode('LNS.50100').paramValue == 'TRUE'}">
<div class="form-group fieldcontain ${hasErrors(bean: loanInstance, field: 'pnNo', 'has-error')}">
    ...
    <div class="col-sm-8">
        <g:textField class="form-control" name="pnNo" maxlength="10" value="${loanInstance?.pnNo}" disabled="disable"/>
