                            ...
                            <div class="section-container">
                                ...
                                <table class="table table-bordered table-striped">
                                    <tbody>
                                        ...
                                        <g:if test="${loanLedgerInstance?.othersDebit > 0}">
                                         <tr>
                                            <td style="font-weight:bold" width="30%">Others Debit</td>
                                            <td width="70%"><g:formatNumber format="###,###,##0.00" number="${loanLedgerInstance?.othersDebit}" /></td>
                                        </tr>
                                        </g:if>
                                         <g:if test="${loanLedgerInstance?.othersCredit > 0}">
                                         <tr>
                                            <td style="font-weight:bold" width="30%">Others Credit</td>
                                            <td width="70%"><g:formatNumber format="###,###,##0.00" number="${loanLedgerInstance?.othersCredit}" /></td>
                                        </tr>
                                        </g:if>
                                        <tr>
