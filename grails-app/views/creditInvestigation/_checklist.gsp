...
<div class="fieldcontain form-group ${hasErrors(bean: creditInvestigationInstance, field: 'remarks', 'has-error')} ">
    ...
    <div class="col-sm-8">
        <g:textArea id="remarksChecklist" name="remarksChecklist" cols="40" rows="5" value="${creditInvestigationInstance?.remarks}" class="form-control" />
...
<div class="fieldcontain form-group ${hasErrors(bean: cfgAcctGlTemplateDetInstance, field: 'glTemplate', 'has-error')} required">
	<label class="control-label col-sm-4" for="glTemplate">
		<g:message code="cfgAcctGlTemplateDet.glTemplate.label" default="Checklist Type" />
		<span class="required-indicator">*</span>
	</label>
	<div class="col-sm-8">
            <g:select id="checklisttype" name="checklisttype" from="${icbs.lov.CreditInvestigationChecklistType.list()}" onchange="changeFormchecklist();" optionValue="description" optionKey="id" required="" value="${creditInvestigationInstance?.checklisttype?.id}"  class="many-to-one form-control"/>
        </div>             
</div>
</br></br></br>
