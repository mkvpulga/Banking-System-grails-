        ...
        <div id="show-creditInvestigation" class="content scaffold-show" role="main">
            ...
            <div class="nav-tab-container">
                <ul class="nav nav-tabs">
                    <g:each in="${idRatedSectionList}" status="i" var="ratedInstance">    
                        <g:if test="${i == 0}" >
            ...
            <g:form name="myForm" id="saveRatedform" url="[action:'saveRatedScoringItems',controller:'creditInvestigation']" method="POST" >
                    ...
                    <g:each in="${idRatedSectionList}" status="i" var="ratedInstance"> 
                        ...
                        <g:if test="${i == 0}" >
                            <div class  ="tab-pane active fade in table-responsive"  id="tab_${ratedInstance.id}">
                                ...
                                <div class="col-sm-8">
                                   <g:if test="${CreditScoringRatedItemsRecords.findByCreditScoringRatedAndLoanApplication(ratedInstance,creditInvestigationInstance?.loanApplication)}">
                                    ...
                                    <g:else>
                                        <g:textArea id="remarks" name="remarks"  class="form-control" />
