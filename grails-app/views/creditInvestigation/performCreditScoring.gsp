	...
	<body>  
		...
		<div id="show-creditInvestigation" class="content scaffold-show" role="main">
			...
			<div class="nav-tab-container">
                        ...
                        <g:form name="myForm" id="saveFormCreditScoringDetails" url="[action:'saveCreditScoringChecklist',controller:'creditInvestigation']" method="POST" >
                                    ...
                                    <g:if test="${i == 0}" >
                                        <div class="tab-pane active fade in table-responsive"  id="tab_${scoringsectionInstancex.id}">
                                            <g:each in="${CreditScoringQuestions.findAllByCreditScoringQuestionSection(CreditScoringQuestionSection.get(scoringsectionInstancex.id),[sort: "id", order: "asc"] )}" status="j" var="questionXs">  
                                                ...
                                                <div class="col-sm-2"><g:select noSelection="['':'-Set Score Here-']" id="xcode" name="xcode" from="${icbs.lov.CreditScoringAnswers.findAllByStatusAndCode(true,'charAnswer',[sort: "id", order: "asc"])}" optionKey="id" optionValue="description" value="" class="many-to-one form-control" ></g:select></div>
         ...
         <content tag="main-actions">
            <ul>
                <li><button onclick="saveCreditScoring();">Save Credit Scoring Details</button></li>
                <script>
