    ...
    <div id="grid">
        <div class="table-responsive">
                <table class="table table-hover table-condensed table-bordered table-striped">
                    <tr>    
                        <g:sortableColumn property="txn_date" title="${message(code: 'customer.type.label', default: 'Txn Date')}" />
                        <g:sortableColumn property="mti" title="${message(code: 'customer.customerId.label', default: 'MTI')}" />
                        <g:sortableColumn property="acct1" title="${message(code: 'customer.branch.label', default: 'Acct1')}" />
                        <g:sortableColumn property="atm_card_number" title="${message(code: 'customer.displayName.label', default: 'Display ')}" />
                        <td>Address</td>
