  	...
  	<content tag="breadcrumbs">
		...
		<div class="table-responsive">
			...
			<tbody>
				...
				<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                    ...
                                    <td><g:link class="btn btn-primary" controller="ATMInterface" action="atmTxnDetails" id="${branchInstance.id}" params="['atmtxnid': branchInstance.id]">View</g:link></td>    
				</tr>
                            </g:each>
			</tbody>
                    </table>
        ...
        <content tag="main-actions">
            <ul>
                ...
                <li><g:link action="viewAtmMsgRequest">View ATM Interface Request</g:link></li>
                <li><g:link action="viewAtmMsgResponse">View ATM Interface Response</g:link></li>
            </ul>
        </content>
    </body>
</html>
