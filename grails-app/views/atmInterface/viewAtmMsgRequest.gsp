...
<html>
    ...
    <body>
		...
		<g:form class="form-inline" url="[action:'viewAtmMsgRequest',controller:'ATMInterface']" method="POST">
		...
		<div class="table-responsive">
				...
				<g:sortableColumn property="dateReceived" title="${message(code: 'AtmTxn.acct1.label', default: 'Date Received')}" />
				<th>Action</th>
			...
			<tbody>
				...
				<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                    ...
                                    <td>${fieldValue(bean: branchInstance, field: "dateReceived")}</td>
                                    
                                    <td><g:link class="btn btn-primary" controller="ATMInterface" action="showRequestDetails" id="${branchInstance.id}">View Response Details</g:link></td>    
				</tr>
                            </g:each>
			</tbody>
                    </table>
        ...
        <content tag="main-actions">
            <ul>
                ...
                <li><g:link action="viewAtmMsgResponse" controller="ATMInterface" >View Response Message Details</g:link></li>
