		...
		<div id="show-userMessage" class="content scaffold-show" role="main">
			...
			<ul class="property-list userMessage">
				...
				<li class="fieldcontain">
                                        ...
                                        <hr />
                                        <div id="msgdisp"></div>
                                        <span id="body-label" class="property-label"><g:message code="userMessage.body.label" default="Message content" /></span>
                                      
					<textarea class="form-control textarea" cols="80" rows="10"  disabled="" >${userMessageInstance?.body}</textarea>
                                        <hr />
                                        <script>
