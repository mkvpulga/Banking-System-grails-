    ...
    <body>
                                            ...
                                            <td>
                                                 <g:if test="${domainInstance?.txnType?.id == 9}">
                                                    <a class="btn btn-primary" onclick="alertify.confirm(AppTitle,'Print Memo Transaction - (Credit Adjustment) Validation Slip?',
                                                       function(){
                                                           var w = window.open('/icbs/deposit/MemoTransactionValidationSlip/${domainInstance?.id}', '_blank');
                                                               w.print()
                                                           },
        ...
        <content tag="main-actions">
            <ul>
                ...
                <!--
                <li><g:link action="depositDebitMemoBills" id="${depositInstance.id}" resource="${depositInstance}" disable="disabled" class="disabled">Debit Memo Bills Payment</g:link></li>
                <li><g:link action="depositDebitMemoRem" id="${depositInstance.id}" resource="${depositInstance}" disable="disabled" class="disabled">Debit Memo Remittance</g:link></li>
                <li><g:link action="depositCreditMemoRem" id="${depositInstance.id}" resource="${depositInstance}" disable="disabled" class="disabled">Credit Memo Remittance</g:link></li> -->    
                <li>
