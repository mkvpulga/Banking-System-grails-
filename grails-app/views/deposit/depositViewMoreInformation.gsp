            ...
            <ul>
                ...
                <g:javascript>
                    function genReportDEP007(){
                        reportlink = "${icbs.admin.Institution.findByParamCode('GEN.10251').paramValue}${icbs.admin.Report.get(14).baseParams}&output=${icbs.admin.Report.get(14).outputParam}";
                    ...
                    <div class="modal-content">
                        ...
                        <g:javascript>
                            function genReportDEP008(){
                                reportlink = "${icbs.admin.Institution.findByParamCode('GEN.10251').paramValue}${icbs.admin.Report.get(15).baseParams}&output=${icbs.admin.Report.get(15).outputParam}";
