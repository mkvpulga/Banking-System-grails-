			...
			<ul class="errors" role="alert">
				...
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                        ...
                        <g:if test="${firstCreate==true}">         
                                <g:form id="saveDepositForm"url="[controller:'deposit',action:'create']" onsubmit="callLoadingDialog();">
                        ...
                        <g:else>
                                <g:form id="saveDepositForm" onsubmit="callLoadingDialog();" url="[resource:depositInstance,controller:'deposit', action:'save']" >
                                        <g:hiddenField name="firstCreate" value="${firstCreate}"/>
                                        <fieldset class="form">
