    ...
    methods: {
       ...
       addTransaction: function(e) {
           ...
           // console.log(this.data.newAmount);
            ...
            this.lineNo++;
            var addpadZeroo = '0000';
            this.newLineNo = addpadZeroo +''+this.lineNo;
        ...
        saveBatchTransactions: function (e) {
            ...
            if(typeof batchId == 'undefined') {
                //console.log("self.branch: "+self.branch);
                //console.log("userBranchId: "+$('#userBranchId').val());
                var xBranchId = $('#userBranchId').val();
                if(xBranchId.toString() == self.branch.toString()){
                    // same branch create
                    $.ajax({
                        type: 'POST',
                    ...
                    alertify.confirm(AppTitle,"Gl Batch Branch is different from your Home Branch would you like to continue this process?",
                        function(){
                            $.ajax({
                                type: 'POST',
                                url: saveBatchTransactionsAjaxLink,
