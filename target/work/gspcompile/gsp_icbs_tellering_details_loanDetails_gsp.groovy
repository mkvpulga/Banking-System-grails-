...
printHtmlPart(19)
invokeTag('formatNumber','g',89,['format':("###,###,##0.00"),'number':(loanInstance?.grantedAmount)],-1)
printHtmlPart(20)
invokeTag('formatNumber','g',93,['format':("###,###,##0.00"),'number':(loanInstance?.totalNetProceeds - loanInstance?.totalDisbursementAmount)],-1)
printHtmlPart(21)
...
public static final long LAST_MODIFIED = 1570673129407L
