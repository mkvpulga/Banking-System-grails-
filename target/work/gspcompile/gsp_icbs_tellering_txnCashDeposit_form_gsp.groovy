...
printHtmlPart(9)
invokeTag('render','g',22,['template':("/tellering/details/depositDetails"),'model':([depositInstance:txnCashDepositInstance?.acct])],-1)
printHtmlPart(10)
if(true && (txnCashDepositInstance?.acct)) {
printHtmlPart(11)
invokeTag('render','g',25,['template':("/tellering/details/signatureDetails"),'model':([depositInstance:txnCashDepositInstance?.acct])],-1)
printHtmlPart(12)
invokeTag('render','g',26,['template':("/tellering/details/signatoryDetails"),'model':([depositInstance:txnCashDepositInstance?.acct])],-1)
printHtmlPart(13)
}
printHtmlPart(14)
expressionOut.print(hasErrors(bean: txnCashDepositInstance, field: 'passbookBal', 'has-error'))
printHtmlPart(15)
invokeTag('textField','g',34,['id':("passbookBal"),'name':("passbookBal"),'required':(""),'value':(txnCashDepositInstance?.passbookBal),'class':("form-control truncated")],-1)
printHtmlPart(10)
invokeTag('textField','g',35,['id':("passbooksw"),'name':("passbooksw"),'value':(txnCashDepositInstance?.passbookBal),'class':("form-control"),'style':("display:none")],-1)
printHtmlPart(16)
...
printHtmlPart(19)
invokeTag('message','g',49,['code':("txnCashDeposit.txnRef.label"),'default':("Transaction Reference")],-1)
printHtmlPart(20)
invokeTag('textArea','g',52,['id':("txnRef"),'name':("txnRef"),'required':(""),'value':(txnCashDepositInstance?.txnRef),'class':("form-control")],-1)
printHtmlPart(21)
}
...
public static final long LAST_MODIFIED = 1570673129429L
