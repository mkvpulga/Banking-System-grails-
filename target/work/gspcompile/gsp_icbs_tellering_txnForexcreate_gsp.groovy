...
invokeTag('eachError','g',50,['bean':(txnForexInstance),'var':("error")],4)
printHtmlPart(16)
})
invokeTag('hasErrors','g',54,['bean':(txnForexInstance)],3)
printHtmlPart(17)
createTagBody(3, {->
printHtmlPart(18)
invokeTag('render','g',57,['template':("txnForex/form"),'model':([txnForexInstance:txnForexInstance])],-1)
printHtmlPart(19)
})
invokeTag('form','g',58,['name':("txnForexForm"),'action':("saveTellerForexTxn"),'controller':("tellering"),'method':("POST")],3)
printHtmlPart(20)
})
...
invokeTag('link','g',65,['action':("index"),'onclick':("return confirm('Are you sure you want to return to the Tellering Index page?');")],3)
printHtmlPart(25)
})
...
public static final long LAST_MODIFIED = 1570673129510L
