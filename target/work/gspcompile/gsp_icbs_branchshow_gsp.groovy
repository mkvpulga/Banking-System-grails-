...
printHtmlPart(21)
invokeTag('formatDate','g',63,['format':("MM/dd/yyyy"),'date':(branchInstance?.openDate)],-1)
printHtmlPart(22)
invokeTag('formatBoolean','g',67,['boolean':(branchInstance?.dataCenter),'true':("Yes"),'false':("No")],-1)
printHtmlPart(23)
...
printHtmlPart(32)
invokeTag('formatDate','g',89,['format':("MM/dd/yyyy"),'date':(branchInstance?.runDate)],-1)
printHtmlPart(33)
...
invokeTag('form','g',131,['name':("remove"),'id':("remove"),'url':([resource:branchInstance, action:'delete']),'method':("DELETE")],3)
printHtmlPart(42)
createClosureForHtmlPart(41, 3)
invokeTag('form','g',133,['name':("closed"),'id':("closed"),'url':([resource:branchInstance, action:'close']),'method':("DELETE")],3)
printHtmlPart(43)
})
...
invokeTag('link','g',139,['action':("takeAction"),'params':([isApproved:true]),'resource':(branchInstance)],4)
printHtmlPart(47)
createClosureForHtmlPart(48, 4)
invokeTag('link','g',140,['action':("takeAction"),'params':([isApproved:false]),'resource':(branchInstance)],4)
printHtmlPart(49)
}
printHtmlPart(42)
if(true && (!isPending)) {
printHtmlPart(50)
createTagBody(4, {->
invokeTag('message','g',143,['code':("default.new.label"),'args':([entityName])],-1)
})
invokeTag('link','g',143,['class':("create"),'action':("create")],4)
printHtmlPart(51)
createTagBody(4, {->
invokeTag('message','g',144,['code':("default.button.edit.label"),'default':("Edit")],-1)
})
invokeTag('link','g',144,['action':("edit"),'resource':(branchInstance)],4)
printHtmlPart(51)
invokeTag('actionSubmit','g',145,['id':("deleteBranch"),'resource':(branchInstance),'action':("delete"),'value':(message(code: 'default.button.delete.label', default: 'Delete')),'onclick':("return confirm('${message(code: 'branch.button.close.confirm.message', default: 'Are you sure you want this branch to be deleted?')}');")],-1)
printHtmlPart(47)
invokeTag('actionSubmit','g',146,['id':("closeBranch"),'resource':(branchInstance),'action':("close"),'value':(message(code: 'default.button.close.label', default: 'Close')),'onclick':("return confirm('${message(code: 'branch.button.close.confirm.message', default: 'Are you sure you want to close this branch?')}');")],-1)
printHtmlPart(52)
invokeTag('actionSubmit','g',148,['form':("show"),'action':("delete"),'value':(message(code: 'default.button.delete.label', default: 'Delete')),'onclick':("return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');")],-1)
printHtmlPart(53)
invokeTag('actionSubmit','g',149,['form':("show"),'action':("close"),'value':(message(code: 'branch.button.close.label', default: 'Close')),'onclick':("return confirm('${message(code: 'branch.button.close.confirm.message', default: 'Are you sure you want to close this branch?')}');")],-1)
printHtmlPart(54)
}
printHtmlPart(55)
})
...
public static final long LAST_MODIFIED = 1570673127930L
