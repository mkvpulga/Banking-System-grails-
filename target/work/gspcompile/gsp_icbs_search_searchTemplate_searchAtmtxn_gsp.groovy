...
class gsp_icbs_search_searchTemplate_searchAtmtxn_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/search/searchTemplate/_searchAtmtxn.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(11)
invokeTag('sortableColumn','g',36,['property':("txn_date"),'title':(message(code: 'customer.type.label', default: 'Txn Date'))],-1)
printHtmlPart(12)
invokeTag('sortableColumn','g',37,['property':("mti"),'title':(message(code: 'customer.customerId.label', default: 'MTI'))],-1)
printHtmlPart(12)
invokeTag('sortableColumn','g',38,['property':("acct1"),'title':(message(code: 'customer.branch.label', default: 'Acct1'))],-1)
printHtmlPart(12)
invokeTag('sortableColumn','g',39,['property':("atm_card_number"),'title':(message(code: 'customer.displayName.label', default: 'Display '))],-1)
printHtmlPart(13)
...
printHtmlPart(17)
invokeTag('set','g',53,['var':("primaryAddress"),'value':((domainInstance?.addresses?.find{it.isPrimary==true}))],-1)
printHtmlPart(18)
...
printHtmlPart(18)
invokeTag('hiddenField','g',64,['id':("actionTemplate"),'name':("actionTemplate"),'value':(params.actionTemplate)],-1)
printHtmlPart(18)
invokeTag('render','g',65,['template':("actionTemplate/${params.actionTemplate}"),'model':([customerInstance:domainInstance])],-1)
printHtmlPart(25)
}
else {
printHtmlPart(26)
...
public static final long LAST_MODIFIED = 1570673129349L
