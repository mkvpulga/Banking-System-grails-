...
invokeTag('hasErrors','g',22,['bean':(clearingBankInstance)],3)
printHtmlPart(16)
createTagBody(3, {->
printHtmlPart(17)
...
invokeTag('form','g',34,['id':("create"),'url':([resource:clearingBankInstance, action:'save'])],3)
printHtmlPart(19)
})
...
createTagBody(2, {->
printHtmlPart(20)
invokeTag('submitButton','g',55,['name':("create"),'id':("createClearingBank"),'class':("btn btn-primary"),'value':(message(code: 'default.button.create.label', default: 'Create')),'onclick':("""
...
printHtmlPart(21)
createTagBody(3, {->
invokeTag('message','g',57,['code':("default.cancel.label"),'args':([entityName]),'default':("Cancel")],-1)
})
invokeTag('link','g',57,['action':("index")],3)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1570673128027L
