...
printHtmlPart(17)
invokeTag('sortableColumn','g',36,['property':("openDate"),'title':(message(code: 'cashInBank.openDate.date', default: 'Opening Date'))],-1)
printHtmlPart(16)
invokeTag('sortableColumn','g',37,['property':("currency"),'title':(message(code: 'cashInBank.currency.label', default: 'Currency'))],-1)
printHtmlPart(18)
loop:{
int i = 0
...
printHtmlPart(21)
invokeTag('formatDate','g',47,['format':("MM/dd/yyyy"),'date':(cashInBankInstance?.openDate)],-1)
printHtmlPart(21)
expressionOut.print(cashInBankInstance?.currency?.code)
printHtmlPart(21)
createClosureForHtmlPart(22, 4)
invokeTag('link','g',49,['class':("btn btn-secondary"),'action':("show"),'id':(cashInBankInstance.id)],4)
printHtmlPart(23)
i++
}
}
printHtmlPart(24)
invokeTag('paginate','g',56,['total':(CashInBankInstanceCount ?: 0),'params':(params)],-1)
printHtmlPart(25)
})
...
invokeTag('link','g',63,['controller':("home"),'action':("landing")],3)
printHtmlPart(29)
createClosureForHtmlPart(30, 3)
invokeTag('link','g',64,['controller':("cashInBank"),'action':("create")],3)
printHtmlPart(29)
createClosureForHtmlPart(31, 3)
invokeTag('link','g',65,['controller':("home"),'action':("landing")],3)
printHtmlPart(32)
})
...
public static final long LAST_MODIFIED = 1570673127988L
