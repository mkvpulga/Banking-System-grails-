...
invokeTag('eachError','g',54,['bean':(financialDetail?.value),'field':("value")],2)
printHtmlPart(11)
})
invokeTag('hasErrors','g',57,['bean':(financialDetail),'field':("value")],1)
printHtmlPart(16)
invokeTag('select','g',63,['class':("form-control"),'id':("type"),'name':("type.id"),'from':(icbs.lov.LoanFinancialInfoType.list()),'optionKey':("id"),'optionValue':("description"),'value':(financialDetail?.type?.id)],-1)
printHtmlPart(17)
}
...
public static final long LAST_MODIFIED = 1570695625165L
