...
printHtmlPart(4)
invokeTag('formatDate','g',24,['format':("MM/dd/yyyy"),'date':(groupInstance?.meetingDate)],-1)
printHtmlPart(5)
invokeTag('formatDate','g',28,['format':("MM/dd/yyyy"),'date':(groupInstance?.dateCreated)],-1)
printHtmlPart(6)
