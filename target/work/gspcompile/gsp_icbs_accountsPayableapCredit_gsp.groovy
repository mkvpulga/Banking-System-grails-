...
printHtmlPart(14)
invokeTag('select','g',51,['id':("txnType"),'name':("txnType"),'from':(icbs.admin.TxnTemplate.findAllByTxnTypeAndMemoTxnType(icbs.lov.TxnType.read(50),icbs.lov.MemoTxnType.read(1))),'optionKey':("id"),'optionValue':("description"),'required':(""),'value':(""),'onchange':("getcode();"),'class':("many-to-one form-control")],-1)
printHtmlPart(15)
invokeTag('field','g',57,['class':("form-control truncated"),'id':("creditAmt"),'name':("creditAmt"),'value':("")],-1)
printHtmlPart(16)
invokeTag('hiddenField','g',60,['name':("apCredit"),'id':("apCredit"),'value':(params.id)],-1)
printHtmlPart(17)
...
invokeTag('form','g',75,['id':("deposit"),'url':([resource:accountsPayableInstance, action:'saveapCredit']),'method':("PUT")],3)
printHtmlPart(20)
})
...
createTagBody(2, {->
printHtmlPart(22)
invokeTag('actionSubmit','g',90,['class':("save"),'id':("saveapCredit"),'name':("saveapCredit"),'action':("saveapCredit"),'value':(message(code: 'default.button.Save.label', default: 'Save')),'onclick':("""
...
public static final long LAST_MODIFIED = 1570673127871L
