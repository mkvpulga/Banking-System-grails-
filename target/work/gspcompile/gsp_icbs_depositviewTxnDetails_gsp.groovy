...
createTagBody(2, {->
printHtmlPart(30)
expressionOut.print(g.createLink(controller: 'deposit', action: 'depositTransactionValidationSlip', params: [txnFile:txnFileInstance?.id]))
printHtmlPart(31)
createClosureForHtmlPart(32, 3)
invokeTag('link','g',120,['action':("depositInquiry"),'id':(txnFileInstance?.depAcct?.id)],3)
printHtmlPart(33)
expressionOut.print([txnId: txnFileInstance.id])
printHtmlPart(34)
})
...
public static final long LAST_MODIFIED = 1570673128845L
