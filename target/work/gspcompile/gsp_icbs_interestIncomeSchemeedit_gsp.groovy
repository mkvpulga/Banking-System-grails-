...
invokeTag('hasErrors','g',60,['bean':(interestIncomeSchemeInstance)],3)
printHtmlPart(8)
createTagBody(3, {->
printHtmlPart(10)
invokeTag('hiddenField','g',62,['name':("version"),'value':(interestIncomeSchemeInstance?.version)],-1)
printHtmlPart(11)
...
invokeTag('form','g',81,['id':("edit"),'url':([resource:interestIncomeSchemeInstance, action:'update']),'method':("PUT")],3)
printHtmlPart(14)
})
...
printHtmlPart(16)
invokeTag('submitButton','g',95,['name':("edit"),'id':("editInterestIncomeScheme"),'class':("btn btn-primary"),'value':(message(code: 'default.button.update.label', default: 'Update')),'onclick':("""
...
invokeTag('link','g',96,['action':("show"),'id':(interestIncomeSchemeInstance.id),'onclick':("return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');")],3)
printHtmlPart(19)
})
...
public static final long LAST_MODIFIED = 1570673129028L
