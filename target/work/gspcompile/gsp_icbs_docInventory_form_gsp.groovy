...
invokeTag('eachError','g',85,['bean':(docInventoryInstance),'field':("checkAcctNo")],2)
printHtmlPart(8)
})
invokeTag('hasErrors','g',88,['bean':(docInventoryInstance),'field':("checkAcctNo")],1)
printHtmlPart(16)
}
...
public static final long LAST_MODIFIED = 1570673128902L
