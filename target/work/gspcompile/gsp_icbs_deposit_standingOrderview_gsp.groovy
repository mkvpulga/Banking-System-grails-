...
createTagBody(2, {->
printHtmlPart(14)
invokeTag('render','g',71,['template':("/customer/details/customerDetails"),'model':([customerInstance:depositInstance?.customer])],-1)
printHtmlPart(15)
invokeTag('render','g',75,['template':("/deposit/details/depositDetails"),'model':([depositInstance:depositInstance])],-1)
printHtmlPart(16)
invokeTag('render','g',81,['template':("/search/searchTemplate/deposit/standingOrder/viewGrid")],-1)
printHtmlPart(17)
invokeTag('render','g',92,['template':("/deposit/details/depositInfo"),'model':([depositInstance:depositInstance])],-1)
printHtmlPart(18)
invokeTag('render','g',111,['template':("/deposit/details/depositInfo"),'model':([depositInstance:depositInstance])],-1)
printHtmlPart(19)
})
...
invokeTag('captureContent','sitemesh',137,['tag':("main-actions")],2)
printHtmlPart(13)
})
...
public static final long LAST_MODIFIED = 1570673128829L
