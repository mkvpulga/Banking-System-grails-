...
printHtmlPart(8)
invokeTag('select','g',24,['id':("txnType"),'name':("txnType"),'from':(icbs.admin.TxnTemplate.findAllByTxnTypeAndMemoTxnType(icbs.lov.TxnType.read(43),icbs.lov.MemoTxnType.read(1))),'optionKey':("id"),'optionValue':("description"),'required':(""),'value':(""),'onchange':("getcode();"),'class':("many-to-one form-control")],-1)
printHtmlPart(9)
invokeTag('field','g',30,['class':("form-control truncated"),'id':("debitAdjustment"),'name':("debitAdjustment"),'value':("")],-1)
printHtmlPart(10)
invokeTag('hiddenField','g',33,['name':("cibDebit"),'id':("cibDebit"),'value':(params.id)],-1)
printHtmlPart(11)
...
invokeTag('form','g',48,['id':("deposit"),'url':([resource:cashInBankInstance, action:'savecibDebit']),'method':("PUT")],3)
printHtmlPart(14)
})
...
createTagBody(2, {->
printHtmlPart(16)
invokeTag('actionSubmit','g',63,['class':("save"),'id':("savecibDebit"),'name':("savecibDebit"),'action':("savecibDebit"),'value':(message(code: 'default.button.Save.label', default: 'Save')),'onclick':("""
...
public static final long LAST_MODIFIED = 1570673127965L
