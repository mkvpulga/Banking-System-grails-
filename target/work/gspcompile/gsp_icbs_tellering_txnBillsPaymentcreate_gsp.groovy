...
printHtmlPart(14)
invokeTag('img','g',57,['dir':("images"),'file':("validate.png"),'width':("35"),'height':("35")],-1)
printHtmlPart(15)
invokeTag('img','g',65,['dir':("images"),'file':("transactionslip.png"),'width':("35"),'height':("35")],-1)
printHtmlPart(16)
}
printHtmlPart(17)
createTagBody(3, {->
printHtmlPart(18)
invokeTag('render','g',73,['template':("txnBillsPayment/form"),'model':([txnBillsPaymentInstance:txnBillsPaymentInstance])],-1)
printHtmlPart(12)
})
invokeTag('form','g',74,['name':("txnBillsPaymentForm"),'action':("saveTellerOtherCashReceiptBillsPaymentTxn"),'controller':("tellering")],3)
printHtmlPart(19)
})
invokeTag('captureContent','sitemesh',76,['tag':("main-content")],2)
printHtmlPart(20)
createClosureForHtmlPart(21, 2)
invokeTag('jasperReport','g',79,['action':("printSLIP"),'controller':("tellering"),'format':("PDF"),'name':("TRANSACTION"),'jasper':("SLIP")],2)
printHtmlPart(2)
createTagBody(2, {->
printHtmlPart(22)
...
public static final long LAST_MODIFIED = 1570673129428L
