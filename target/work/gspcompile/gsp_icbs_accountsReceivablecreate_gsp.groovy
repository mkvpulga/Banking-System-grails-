...
invokeTag('eachError','g',17,['bean':(accountsReceivableInstance),'var':("error")],4)
printHtmlPart(14)
})
invokeTag('hasErrors','g',19,['bean':(accountsReceivableInstance)],3)
printHtmlPart(7)
createTagBody(3, {->
printHtmlPart(15)
...
invokeTag('form','g',24,['id':("create"),'url':([resource:cashInBankInstance, action:'save'])],3)
printHtmlPart(17)
})
