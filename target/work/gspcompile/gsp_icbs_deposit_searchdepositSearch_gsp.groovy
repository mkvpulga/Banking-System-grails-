...
createTagBody(2, {->
printHtmlPart(5)
invokeTag('render','g',16,['template':("/search/searchTemplate/searchDeposit")],-1)
printHtmlPart(2)
})
...
invokeTag('link','g',20,['class':(""),'action':("create"),'resource':("")],3)
printHtmlPart(8)
createClosureForHtmlPart(9, 3)
invokeTag('link','g',21,['action':("/depositInquiry")],3)
printHtmlPart(10)
})
invokeTag('captureContent','sitemesh',23,['tag':("main-actions")],2)
printHtmlPart(4)
})
