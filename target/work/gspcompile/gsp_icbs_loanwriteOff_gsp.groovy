...
createTagBody(3, {->
printHtmlPart(56)
invokeTag('hiddenField','g',901,['name':("version"),'value':(loanInstance?.version)],-1)
printHtmlPart(56)
invokeTag('hiddenField','g',902,['name':("activity"),'value':("Write-Off")],-1)
printHtmlPart(57)
invokeTag('set','g',915,['var':("writeOff"),'value':(true)],-1)
printHtmlPart(58)
invokeTag('render','g',917,['template':("loanApplication/form")],-1)
printHtmlPart(59)
invokeTag('render','g',920,['template':("specification/form")],-1)
printHtmlPart(60)
invokeTag('render','g',923,['template':("classification/form")],-1)
printHtmlPart(61)
invokeTag('render','g',926,['template':("serviceCharges/list")],-1)
printHtmlPart(62)
invokeTag('render','g',929,['template':("deductions/list")],-1)
printHtmlPart(63)
invokeTag('render','g',932,['template':("installments/list")],-1)
printHtmlPart(64)
invokeTag('render','g',935,['template':("sweep/list")],-1)
printHtmlPart(65)
})
invokeTag('form','g',938,['id':("loan-form"),'url':([resource:loanInstance, action:'update']),'method':("PUT"),'onsubmit':("callLoadingDialog();")],3)
printHtmlPart(66)
})
invokeTag('captureContent','sitemesh',940,['tag':("main-content")],2)
printHtmlPart(48)
createTagBody(2, {->
printHtmlPart(67)
invokeTag('submitButton','g',951,['name':("save"),'value':("Save"),'onclick':("""    
...
invokeTag('link','g',952,['controller':(module),'action':("show"),'id':(loanInstance.id),'onclick':("return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');")],3)
printHtmlPart(70)
})
invokeTag('captureContent','sitemesh',954,['tag':("main-actions")],2)
printHtmlPart(47)
})
invokeTag('captureBody','sitemesh',955,[:],1)
printHtmlPart(71)
}
...
public static final long LAST_MODIFIED = 1570673129152L
