...
createTagBody(3, {->
printHtmlPart(40)
invokeTag('hiddenField','g',391,['name':("version"),'value':(collateralInstance?.version)],-1)
printHtmlPart(41)
invokeTag('render','g',402,['template':("details/form")],-1)
printHtmlPart(42)
invokeTag('render','g',405,['template':("pdc/list")],-1)
printHtmlPart(43)
invokeTag('render','g',408,['template':("attachments/list")],-1)
printHtmlPart(44)
invokeTag('render','g',411,['template':("loanApplications/list")],-1)
printHtmlPart(45)
})
invokeTag('form','g',414,['id':("collateral-form"),'onsubmit':("callLoadingDialog();"),'url':([controller:collateralManagement, action:'update', id:collateralInstance?.id]),'method':("PUT")],3)
printHtmlPart(46)
})
invokeTag('captureContent','sitemesh',416,['tag':("main-content")],2)
printHtmlPart(36)
createTagBody(2, {->
printHtmlPart(47)
invokeTag('submitButton','g',419,['id':("save"),'name':("save"),'value':("Save")],-1)
printHtmlPart(48)
createClosureForHtmlPart(49, 3)
invokeTag('link','g',434,['class':("list"),'action':("show"),'id':(collateralInstance.id),'onclick':("return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');")],3)
printHtmlPart(50)
})
invokeTag('captureContent','sitemesh',436,['tag':("main-actions")],2)
printHtmlPart(51)
})
...
public static final long LAST_MODIFIED = 1570673128075L
