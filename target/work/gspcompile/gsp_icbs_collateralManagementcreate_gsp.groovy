...
invokeTag('uploadForm','g',412,['id':("collateral-form"),'onsubmit':("callLoadingDialog();"),'url':([controller:collateralManagement, action:'save'])],3)
printHtmlPart(38)
})
invokeTag('captureContent','sitemesh',413,['tag':("main-content")],2)
printHtmlPart(25)
createTagBody(2, {->
printHtmlPart(39)
invokeTag('submitButton','g',425,['name':("save"),'value':("Save"),'onclick':("""
...
invokeTag('link','g',430,['class':("list"),'action':("index"),'onclick':("return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');")],3)
printHtmlPart(42)
})
invokeTag('captureContent','sitemesh',431,['tag':("main-actions")],2)
printHtmlPart(24)
})
...
public static final long LAST_MODIFIED = 1570673128071L
