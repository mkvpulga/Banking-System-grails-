...
invokeTag('link','g',37,['class':("btn btn-secondary"),'action':("showHistory"),'params':([id:loanInstance.id, history:loanHistoryInstance.id])],2)
printHtmlPart(9)
i++
}
}
...
public static final long LAST_MODIFIED = 1570673129056L
