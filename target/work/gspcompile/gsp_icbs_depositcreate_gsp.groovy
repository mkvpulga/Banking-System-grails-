...
createTagBody(4, {->
printHtmlPart(30)
invokeTag('hiddenField','g',236,['name':("firstCreate"),'value':(firstCreate)],-1)
printHtmlPart(31)
invokeTag('render','g',240,['template':("form/deposit/typeAndProduct")],-1)
printHtmlPart(32)
})
invokeTag('form','g',243,['id':("saveDepositForm"),'url':([controller:'deposit',action:'create']),'onsubmit':("callLoadingDialog();")],4)
printHtmlPart(28)
}
else {
printHtmlPart(33)
createTagBody(4, {->
printHtmlPart(34)
invokeTag('hiddenField','g',247,['name':("firstCreate"),'value':(firstCreate)],-1)
printHtmlPart(35)
invokeTag('render','g',249,['template':("form")],-1)
printHtmlPart(36)
})
invokeTag('form','g',251,['id':("saveDepositForm"),'onsubmit':("callLoadingDialog();"),'url':([resource:depositInstance,controller:'deposit', action:'save'])],4)
printHtmlPart(28)
}
printHtmlPart(37)
})
...
public static final long LAST_MODIFIED = 1570673128291L
