...
printHtmlPart(20)
invokeTag('message','g',56,['code':("userMessage.body.label"),'default':("Message content")],-1)
printHtmlPart(21)
...
printHtmlPart(24)
invokeTag('message','g',106,['code':("userMessage.sentAt.label"),'default':("Sent At")],-1)
printHtmlPart(25)
invokeTag('fieldValue','g',108,['bean':(userMessageInstance),'field':("sentAt")],-1)
printHtmlPart(13)
}
printHtmlPart(14)
if(true && (userMessageInstance?.parentMessage)) {
printHtmlPart(26)
invokeTag('message','g',115,['code':("userMessage.parentMessage.label"),'default':("Parent Message")],-1)
printHtmlPart(27)
createTagBody(4, {->
expressionOut.print(userMessageInstance?.parentMessage?.encodeAsHTML())
})
invokeTag('link','g',117,['controller':("userMessage"),'action':("show"),'id':(userMessageInstance?.parentMessage?.id)],4)
printHtmlPart(13)
}
printHtmlPart(14)
if(true && (userMessageInstance?.configItemStatus)) {
printHtmlPart(28)
invokeTag('message','g',124,['code':("userMessage.configItemStatus.label"),'default':("Status")],-1)
printHtmlPart(29)
...
invokeTag('form','g',133,['id':("show"),'url':([resource:userMessageInstance, action:'delete']),'method':("DELETE")],3)
printHtmlPart(32)
})
...
invokeTag('link','g',139,['action':("reply"),'id':(userMessageInstance.id)],4)
printHtmlPart(37)
}
printHtmlPart(38)
...
printHtmlPart(40)
invokeTag('actionSubmit','g',142,['form':("show"),'action':("delete"),'value':(message(code: 'default.button.delete.label', default: 'Delete')),'onclick':("return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');")],-1)
printHtmlPart(41)
})
...
public static final long LAST_MODIFIED = 1570673129605L
