...
printHtmlPart(10)
invokeTag('set','g',51,['var':("i"),'value':(0)],-1)
printHtmlPart(10)
...
expressionOut.print(pdc?.bank)
printHtmlPart(13)
invokeTag('formatBoolean','g',59,['boolean':(pdc?.onUs)],-1)
printHtmlPart(13)
invokeTag('formatDate','g',60,['format':("MM/dd/yyyy"),'date':(pdc?.pdcDate)],-1)
printHtmlPart(14)
expressionOut.print(i)
printHtmlPart(15)
expressionOut.print(i)
printHtmlPart(16)
invokeTag('set','g',67,['var':("i"),'value':(i = i + 1)],-1)
printHtmlPart(17)
}
printHtmlPart(18)
for( total in (session["pdcs"].sum{it.amount}) ) {
printHtmlPart(19)
invokeTag('formatNumber','g',73,['format':("###,##0.00"),'number':(total)],-1)
printHtmlPart(20)
}
printHtmlPart(21)
}
printHtmlPart(22)
invokeTag('hiddenField','g',113,['name':("pdcId"),'value':("")],-1)
printHtmlPart(23)
}
...
public static final long LAST_MODIFIED = 1570673128084L
