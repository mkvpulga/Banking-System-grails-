...
printHtmlPart(41)
if(true && (depositInstance?.maturityDate)) {
printHtmlPart(42)
expressionOut.print(hasErrors(bean: depositInstance, field: 'maturityDate', 'has-error'))
printHtmlPart(43)
invokeTag('message','g',151,['code':("maturityDate.label"),'default':("Maturity Date")],-1)
printHtmlPart(44)
invokeTag('field','g',154,['name':("currentRollover.endDate"),'readonly':("true"),'precision':("day"),'class':("form-control"),'value':(depositInstance ? depositInstance?.currentRollover?.endDate?:Branch?.get(1).runDate +depositInstance?.fixedDepositTermScheme?.value.toInteger():currentRollover?.endDate)],-1)
printHtmlPart(45)
invokeTag('customDatePicker','g',155,['name':("maturityDate"),'precision':("day"),'class':("form-control"),'value':(depositInstance?.maturityDate)],-1)
printHtmlPart(46)
createTagBody(3, {->
printHtmlPart(47)
createTagBody(4, {->
...
invokeTag('eachError','g',161,['bean':(depositInstance),'field':("currentRollover.endDate")],4)
printHtmlPart(50)
})
invokeTag('hasErrors','g',164,['bean':(depositInstance),'field':("currentRollover.endDate")],3)
printHtmlPart(51)
}
else {
printHtmlPart(36)
invokeTag('hiddenField','g',169,['name':("maturityDate"),'value':(depositInstance?.maturityDate)],-1)
printHtmlPart(52)
}
printHtmlPart(53)
}
...
expressionOut.print(hasErrors(bean: depositInstance, field: 'maturityDate', 'has-error'))
printHtmlPart(33)
invokeTag('message','g',176,['code':("maturityDate.label"),'default':("FD Monthly Transfer")],-1)
printHtmlPart(34)
invokeTag('field','g',179,['name':("currentRollover.endDate"),'readonly':("true"),'precision':("day"),'class':("form-control"),'value':(depositInstance ? depositInstance?.currentRollover?.endDate?:Branch?.get(1).runDate +depositInstance?.fixedDepositTermScheme?.value.toInteger():currentRollover?.endDate)],-1)
printHtmlPart(35)
invokeTag('textField','g',180,['name':("fdMonthlyTransfer"),'value':(depositInstance?.depositInterestScheme?.fdMonthlyTransfer),'disabled':("disable"),'class':("form-control")],-1)
printHtmlPart(36)
createTagBody(2, {->
printHtmlPart(37)
createTagBody(3, {->
...
invokeTag('eachError','g',186,['bean':(depositInstance),'field':("currentRollover.endDate")],3)
printHtmlPart(40)
})
invokeTag('hasErrors','g',189,['bean':(depositInstance),'field':("currentRollover.endDate")],2)
printHtmlPart(54)
expressionOut.print(hasErrors(bean: depositInstance, field: 'maturityDate', 'has-error'))
printHtmlPart(33)
invokeTag('message','g',194,['code':("maturityDate.label"),'default':("Rollover End Date")],-1)
printHtmlPart(34)
invokeTag('field','g',197,['name':("currentRollover.endDate"),'readonly':("true"),'precision':("day"),'class':("form-control"),'value':(depositInstance ? depositInstance?.currentRollover?.endDate?:Branch?.get(1).runDate +depositInstance?.fixedDepositTermScheme?.value.toInteger():currentRollover?.endDate)],-1)
printHtmlPart(35)
invokeTag('customDatePicker','g',198,['name':("rollOverEndDate"),'precision':("day"),'class':("form-control"),'value':(depositInstance?.currentRollover?.endDate)],-1)
printHtmlPart(36)
createTagBody(2, {->
printHtmlPart(37)
createTagBody(3, {->
...
invokeTag('eachError','g',204,['bean':(depositInstance),'field':("currentRollover.endDate")],3)
printHtmlPart(40)
})
invokeTag('hasErrors','g',207,['bean':(depositInstance),'field':("currentRollover.endDate")],2)
printHtmlPart(55)
}
printHtmlPart(1)
}
...
public static final long LAST_MODIFIED = 1570673128318L
