...
createTagBody(2, {->
printHtmlPart(18)
invokeTag('submitButton','g',37,['id':("newCIB"),'name':("create"),'value':(message(code: 'default.button.create.label', default: 'Create')),'onclick':("""
...
public static final long LAST_MODIFIED = 1570673127966L
