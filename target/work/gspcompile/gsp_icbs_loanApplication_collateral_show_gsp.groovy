...
printHtmlPart(3)
invokeTag('formatNumber','g',18,['format':("###,##0.00"),'number':(collateral?.appraisedValue)],-1)
printHtmlPart(4)
expressionOut.print(collateral?.status?.description)
printHtmlPart(2)
createClosureForHtmlPart(5, 2)
invokeTag('link','g',20,['class':("btn btn-secondary"),'controller':("collateralManagement"),'action':("show"),'id':(collateral?.id)],2)
printHtmlPart(6)
}
printHtmlPart(7)
}
...
public static final long LAST_MODIFIED = 1570673129173L
