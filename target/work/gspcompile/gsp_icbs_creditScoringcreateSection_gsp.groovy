...
class gsp_icbs_creditScoringcreateSection_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/creditScoring/createSection.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(14)
invokeTag('textField','g',44,['name':("sectionName"),'id':("sectionName"),'required':(""),'value':(""),'class':("form-control")],-1)
printHtmlPart(15)
invokeTag('field','g',49,['type':("number"),'name':("sectionPercentage"),'id':("sectionPercentage"),'required':(""),'value':(""),'class':("form-control")],-1)
printHtmlPart(16)
})
invokeTag('form','g',50,['name':("creditScoringProduct"),'id':("creditScoringProduct"),'url':([action:'saveSection',controller:'CreditScoring']),'onsubmit':("callLoadingDialog();")],3)
printHtmlPart(17)
})
...
invokeTag('link','g',55,['controller':("creditScoring"),'action':("codeWithQuestionSectionDetails"),'id':(params.id)],3)
printHtmlPart(21)
})
...
public static final long LAST_MODIFIED = 1570673128180L
