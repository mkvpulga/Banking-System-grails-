...
createTagBody(3, {->
printHtmlPart(60)
invokeTag('hiddenField','g',918,['name':("version"),'value':(loanInstance?.version)],-1)
printHtmlPart(60)
invokeTag('hiddenField','g',919,['name':("activity"),'value':("Renewal")],-1)
printHtmlPart(61)
invokeTag('hiddenField','g',920,['name':("loanInstance"),'value':(loanInstance?.id)],-1)
printHtmlPart(62)
invokeTag('render','g',934,['template':("loanApplication/form")],-1)
printHtmlPart(63)
invokeTag('render','g',937,['template':("specification/form")],-1)
printHtmlPart(64)
invokeTag('render','g',940,['template':("classification/form")],-1)
printHtmlPart(65)
invokeTag('render','g',943,['template':("serviceCharges/list")],-1)
printHtmlPart(66)
invokeTag('render','g',946,['template':("deductions/listRenew")],-1)
printHtmlPart(67)
invokeTag('render','g',949,['template':("installments/list")],-1)
printHtmlPart(68)
invokeTag('render','g',952,['template':("sweep/list")],-1)
printHtmlPart(69)
})
invokeTag('form','g',955,['id':("loan-form"),'url':([resource:loanInstance, action:'saveNew']),'onsubmit':("callLoadingDialog();")],3)
printHtmlPart(70)
})
invokeTag('captureContent','sitemesh',957,['tag':("main-content")],2)
printHtmlPart(6)
createTagBody(2, {->
printHtmlPart(71)
invokeTag('submitButton','g',972,['name':("save"),'value':("Save"),'onclick':("""   
...
invokeTag('link','g',973,['controller':("loan"),'action':("index"),'id':(loanInstance.id),'onclick':("return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');")],3)
printHtmlPart(74)
})
invokeTag('captureContent','sitemesh',975,['tag':("main-actions")],2)
printHtmlPart(52)
})
invokeTag('captureBody','sitemesh',976,[:],1)
printHtmlPart(75)
}
...
public static final long LAST_MODIFIED = 1570673129068L
