...
expressionOut.print(hasErrors(bean: txnTemplateInstance, field: 'validationFormCode', 'has-error'))
printHtmlPart(24)
invokeTag('message','g',434,['code':("txnTemplate.validationFormCode.label"),'default':("Validation Form Code")],-1)
printHtmlPart(17)
invokeTag('textField','g',438,['readonly':("true"),'name':("validationFormCode"),'id':("validationFormCode"),'value':(txnTemplateInstance?.validationFormCode),'class':("form-control")],-1)
printHtmlPart(3)
createTagBody(1, {->
printHtmlPart(4)
createTagBody(2, {->
...
public static final long LAST_MODIFIED = 1570673129581L
