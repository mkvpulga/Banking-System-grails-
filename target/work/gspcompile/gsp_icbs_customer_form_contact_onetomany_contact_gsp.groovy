...
printHtmlPart(10)
invokeTag('select','g',24,['id':("contacts[${i}].type"),'name':("contacts[${i}].type.id"),'from':(icbs.lov.Lov.findAllByGroupCodeAndStatusAndItemCodeInList("CON",true,['001','002'])),'optionKey':("id"),'required':(""),'optionValue':("itemValue"),'value':(contact?.type?.id),'class':("form-control")],-1)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(12)
createTagBody(3, {->
...
printHtmlPart(10)
invokeTag('textField','g',132,['name':("contacts[${i}].contactValue"),'maxlength':("50"),'value':("nodata@noemail"),'class':("form-control")],-1)
printHtmlPart(11)
createTagBody(3, {->
printHtmlPart(12)
createTagBody(4, {->
...
expressionOut.print(i)
printHtmlPart(18)
invokeTag('message','g',185,['code':("contact.contactValue.label"),'default':("Social Media Account")],-1)
printHtmlPart(34)
...
public static final long LAST_MODIFIED = 1570673128219L
