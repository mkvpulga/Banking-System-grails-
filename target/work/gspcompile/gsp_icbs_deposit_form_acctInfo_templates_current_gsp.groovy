...
printHtmlPart(11)
invokeTag('select','g',33,['id':("depositInterestScheme"),'name':("depositInterestScheme.id"),'from':(icbs.deposit.DepositInterestScheme.list()),'optionKey':("id"),'value':(depositInstance?.depositInterestScheme?.id),'class':("many-to-one form-control"),'noSelection':(['null': ''])],-1)
printHtmlPart(12)
createTagBody(1, {->
printHtmlPart(13)
createTagBody(2, {->
...
public static final long LAST_MODIFIED = 1570673128315L
