...
invokeTag('eachError','g',18,['bean':(fixedDepositPreTermSchemeInstance),'var':("error")],4)
printHtmlPart(15)
})
invokeTag('hasErrors','g',20,['bean':(fixedDepositPreTermSchemeInstance)],3)
printHtmlPart(8)
createTagBody(3, {->
printHtmlPart(16)
...
invokeTag('form','g',25,['id':("fixedDepositPreTermSchemeForm"),'url':([resource:fixedDepositPreTermSchemeInstance, action:'save'])],3)
printHtmlPart(18)
})
...
createTagBody(2, {->
printHtmlPart(19)
invokeTag('submitButton','g',39,['name':("create"),'id':("newFixedDepositPreTermScheme"),'class':("btn btn-primary"),'value':(message(code: 'default.button.create.label', default: 'Create')),'onclick':("""
