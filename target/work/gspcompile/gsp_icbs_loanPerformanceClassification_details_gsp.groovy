...
printHtmlPart(3)
invokeTag('field','g',107,['class':("form-control"),'name':("thresholdAmount"),'value':(fieldValue(bean: loanPerformanceClassificationInstance, field: 'thresholdAmount'))],-1)
printHtmlPart(4)
createTagBody(1, {->
printHtmlPart(5)
createTagBody(2, {->
...
public static final long LAST_MODIFIED = 1570673129231L
