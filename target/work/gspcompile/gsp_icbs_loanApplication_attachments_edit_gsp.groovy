...
class gsp_icbs_loanApplication_attachments_edit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/loanApplication/attachments/_edit.gsp" }
public Object run() {
Writer out = getOut()
...
public static final long LAST_MODIFIED = 1570673129168L
