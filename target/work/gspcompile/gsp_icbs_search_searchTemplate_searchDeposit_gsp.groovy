...
printHtmlPart(9)
invokeTag('sortableColumn','g',60,['property':("branch"),'title':(message(code: 'deposit.branch.label', default: 'Branch'))],-1)
printHtmlPart(11)
invokeTag('sortableColumn','g',66,['property':("status"),'title':(message(code: 'deposit.status.label', default: 'Status'))],-1)
printHtmlPart(12)
loop:{
int i = 0
...
printHtmlPart(24)
invokeTag('paginate','g',101,['total':(domainInstanceCount ?: 0)],-1)
printHtmlPart(25)
}
...
public static final long LAST_MODIFIED = 1570673129350L
