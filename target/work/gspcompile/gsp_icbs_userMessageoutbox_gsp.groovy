...
printHtmlPart(12)
invokeTag('sortableColumn','g',67,['property':("sentAt"),'title':(message(code: 'userMessage.sentAt.label', default: 'Sent At'))],-1)
printHtmlPart(13)
loop:{
int i = 0
...
invokeTag('link','g',85,['action':("show"),'id':(userMessageInstance.id),'class':("bold")],6)
printHtmlPart(20)
}
printHtmlPart(21)
...
invokeTag('link','g',95,['action':("show"),'class':("btn btn-primary"),'id':(userMessageInstance.id)],5)
printHtmlPart(25)
}
printHtmlPart(26)
i++
...
invokeTag('link','g',101,['action':("create")],3)
printHtmlPart(31)
...
public static final long LAST_MODIFIED = 1570673129604L
