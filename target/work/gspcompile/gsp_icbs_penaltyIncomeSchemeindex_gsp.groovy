...
printHtmlPart(13)
invokeTag('sortableColumn','g',43,['property':("code"),'title':(message(code: 'penaltyIncomeScheme.code.label', default: 'Code'))],-1)
printHtmlPart(14)
invokeTag('sortableColumn','g',45,['property':("name"),'title':(message(code: 'penaltyIncomeScheme.name.label', default: 'Name'))],-1)
printHtmlPart(15)
invokeTag('sortableColumn','g',47,['property':("basis"),'title':(message(code: 'penaltyIncomeScheme.basis.label', default: 'Basis'))],-1)
printHtmlPart(14)
invokeTag('sortableColumn','g',49,['property':("status"),'title':(message(code: 'penaltyIncomeScheme.status.label', default: 'Status'))],-1)
printHtmlPart(16)
loop:{
int i = 0
...
invokeTag('link','g',65,['class':("btn btn-secondary"),'action':("show"),'id':(penaltyIncomeSchemeInstance.id)],4)
printHtmlPart(23)
i++
}
}
printHtmlPart(24)
invokeTag('paginate','g',72,['total':(penaltyIncomeSchemeInstanceCount ?: 0)],-1)
printHtmlPart(25)
})
...
public static final long LAST_MODIFIED = 1570673129279L
