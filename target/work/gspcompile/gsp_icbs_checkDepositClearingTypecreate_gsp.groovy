...
invokeTag('eachError','g',18,['bean':(checkDepositClearingTypeInstance),'var':("error")],4)
printHtmlPart(15)
})
invokeTag('hasErrors','g',20,['bean':(checkDepositClearingTypeInstance)],3)
printHtmlPart(16)
createTagBody(3, {->
printHtmlPart(17)
...
invokeTag('form','g',32,['id':("create"),'url':([resource:checkDepositClearingTypeInstance, action:'save'])],3)
printHtmlPart(19)
})
...
createTagBody(2, {->
printHtmlPart(20)
invokeTag('submitButton','g',52,['name':("create"),'id':("newDepositClearingType"),'class':("btn btn-primary"),'value':(message(code: 'default.button.create.label', default: 'Create')),'onclick':("""
...
printHtmlPart(21)
createTagBody(3, {->
invokeTag('message','g',55,['code':("default.cancel.label"),'args':([entityName]),'default':("Cancel")],-1)
})
...
public static final long LAST_MODIFIED = 1570673128006L
