...
invokeTag('eachError','g',19,['bean':(docInventoryInstance),'var':("error")],4)
printHtmlPart(15)
})
invokeTag('hasErrors','g',21,['bean':(docInventoryInstance)],3)
printHtmlPart(8)
createTagBody(3, {->
printHtmlPart(16)
invokeTag('hiddenField','g',23,['name':("version"),'value':(docInventoryInstance?.version)],-1)
printHtmlPart(17)
invokeTag('render','g',25,['template':("form"),'model':([readonly:'true'])],-1)
printHtmlPart(18)
})
invokeTag('form','g',27,['id':("docInventoryForm"),'url':([resource:docInventoryInstance, action:'update']),'method':("PUT")],3)
printHtmlPart(19)
})
...
invokeTag('link','g',33,['class':("list"),'action':("show"),'id':(docInventoryInstance.id)],3)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1570673128904L
