...
invokeTag('javascript','g',441,[:],4)
printHtmlPart(23)
})
invokeTag('form','g',442,['url':([resource:txnTemplateInstance, action:'save'])],3)
printHtmlPart(24)
})
invokeTag('captureContent','sitemesh',444,['tag':("main-content")],2)
printHtmlPart(25)
createTagBody(2, {->
printHtmlPart(26)
expressionOut.print(createLink(uri: '/'))
printHtmlPart(27)
invokeTag('message','g',447,['code':("default.home.label")],-1)
printHtmlPart(28)
createTagBody(3, {->
invokeTag('message','g',449,['code':("default.list.label"),'args':([entityName])],-1)
})
invokeTag('link','g',449,['class':("list"),'action':("index")],3)
printHtmlPart(29)
})
invokeTag('captureContent','sitemesh',451,['tag':("main-actions")],2)
printHtmlPart(3)
})
...
public static final long LAST_MODIFIED = 1570673129585L
