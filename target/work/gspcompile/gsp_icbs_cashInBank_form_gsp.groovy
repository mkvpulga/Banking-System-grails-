...
printHtmlPart(17)
invokeTag('textField','g',151,['name':("glContra"),'maxlength':("25"),'required':(""),'value':(cashInBankInstance?.glContra),'class':("form-control")],-1)
printHtmlPart(2)
createTagBody(1, {->
printHtmlPart(3)
createTagBody(2, {->
...
printHtmlPart(18)
invokeTag('textField','g',166,['name':("remarks"),'maxlength':("100"),'required':(""),'value':(cashInBankInstance?.remarks),'class':("form-control")],-1)
printHtmlPart(2)
createTagBody(1, {->
printHtmlPart(3)
createTagBody(2, {->
...
invokeTag('eachError','g',172,['bean':(cashInBankInstance),'field':("remarks")],2)
printHtmlPart(6)
})
invokeTag('hasErrors','g',175,['bean':(cashInBankInstance),'field':("remarks")],1)
printHtmlPart(19)
}
...
public static final long LAST_MODIFIED = 1570673127933L
