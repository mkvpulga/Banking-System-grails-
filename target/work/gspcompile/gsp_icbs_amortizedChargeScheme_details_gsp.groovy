...
printHtmlPart(18)
invokeTag('field','g',88,['class':("form-control"),'name':("amount"),'value':(fieldValue(bean: amortizedChargeSchemeInstance, field: 'amount'))],-1)
printHtmlPart(4)
createTagBody(1, {->
printHtmlPart(5)
createTagBody(2, {->
...
invokeTag('eachError','g',93,['bean':(amortizedChargeSchemeInstance),'field':("amount")],2)
printHtmlPart(8)
})
...
public static final long LAST_MODIFIED = 1570673127886L
