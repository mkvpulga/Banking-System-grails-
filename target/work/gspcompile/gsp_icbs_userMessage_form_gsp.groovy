...
invokeTag('eachError','g',73,['bean':(userMessageInstance),'field':("body")],2)
printHtmlPart(7)
})
invokeTag('hasErrors','g',76,['bean':(userMessageInstance),'field':("body")],1)
printHtmlPart(13)
invokeTag('hiddenField','g',81,['name':("configItemStatus"),'value':("2")],-1)
printHtmlPart(14)
invokeTag('hiddenField','g',82,['name':("sender"),'value':(session.user_id)],-1)
printHtmlPart(14)
invokeTag('hiddenField','g',83,['name':("sentAt"),'value':(new Date())],-1)
printHtmlPart(14)
invokeTag('hiddenField','g',84,['name':("isRead"),'value':(false)],-1)
printHtmlPart(15)
}
...
public static final long LAST_MODIFIED = 1570673129599L
