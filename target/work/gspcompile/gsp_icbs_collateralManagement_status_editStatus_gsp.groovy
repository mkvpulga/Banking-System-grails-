...
printHtmlPart(7)
invokeTag('select','g',31,['id':("status"),'name':("status.id"),'from':(LoanCollateralStatus.listOrderById(order: "asc")),'optionKey':("id"),'optionValue':("description"),'value':(collateralInstance?.status?.id),'class':("form-control")],-1)
printHtmlPart(8)
createTagBody(2, {->
printHtmlPart(9)
createTagBody(3, {->
...
public static final long LAST_MODIFIED = 1570673128093L
