...
invokeTag('form','g',24,['id':("create"),'url':([resource:accountsPayableInstance, action:'save'])],3)
printHtmlPart(17)
})
...
createTagBody(2, {->
printHtmlPart(18)
invokeTag('submitButton','g',37,['id':("newAR"),'name':("create"),'value':(message(code: 'default.button.create.label', default: 'Create')),'onclick':("""
...
public static final long LAST_MODIFIED = 1570673127873L
