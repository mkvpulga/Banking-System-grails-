...
invokeTag('uploadForm','g',58,['name':("inwardCheckClearingForm"),'action':("viewInwardCheckClearing"),'controller':("deposit")],3)
printHtmlPart(14)
createTagBody(3, {->
printHtmlPart(15)
loop:{
...
invokeTag('uploadForm','g',127,['name':("processInwardCheckingForm"),'onsubmit':("callLoadingDialog();"),'action':("processInwardCheckClearing"),'controller':("deposit")],3)
printHtmlPart(29)
})
...
public static final long LAST_MODIFIED = 1570673128372L
