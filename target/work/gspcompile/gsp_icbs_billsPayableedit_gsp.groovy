...
invokeTag('form','g',26,['id':("edit"),'url':([resource:billsPayableInstance, action:'update']),'method':("PUT")],3)
printHtmlPart(19)
})
...
invokeTag('link','g',41,['action':("show"),'id':(billsPayableInstance.id)],3)
printHtmlPart(24)
})
...
public static final long LAST_MODIFIED = 1570673127920L
