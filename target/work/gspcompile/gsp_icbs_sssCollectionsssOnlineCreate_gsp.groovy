...
class gsp_icbs_sssCollectionsssOnlineCreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/sssCollection/sssOnlineCreate.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(3, {->
printHtmlPart(11)
invokeTag('textField','g',34,['id':("ssstxnBillRef"),'name':("ssstxnBillRef"),'required':(""),'class':("form-control")],-1)
printHtmlPart(12)
invokeTag('hiddenField','g',35,['name':("wsdlMethod"),'id':("wsdlMethod"),'value':("loadEmployerStatus")],-1)
printHtmlPart(13)
})
invokeTag('form','g',39,['id':("create"),'url':([action:'sssConfirmBillerRef',controller: 'SssCollection']),'onsubmit':("callLoadingDialog();")],3)
printHtmlPart(14)
})
...
public static final long LAST_MODIFIED = 1570673129394L
