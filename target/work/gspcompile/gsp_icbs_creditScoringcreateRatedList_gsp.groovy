...
class gsp_icbs_creditScoringcreateRatedList_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/creditScoring/createRatedList.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(14)
invokeTag('textArea','g',44,['name':("ratedName"),'id':("ratedName"),'rows':("5"),'cols':("40"),'required':(""),'value':(""),'class':("form-control")],-1)
printHtmlPart(15)
})
invokeTag('form','g',44,['name':("creditScoringRated"),'id':("creditScoringRated"),'url':([action:'saveRatedSection',controller:'CreditScoring']),'onsubmit':("callLoadingDialog();"),'method':("POST")],3)
printHtmlPart(16)
})
...
public static final long LAST_MODIFIED = 1570673128179L
