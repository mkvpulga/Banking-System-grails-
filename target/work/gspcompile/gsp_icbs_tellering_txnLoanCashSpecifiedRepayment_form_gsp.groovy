...
printHtmlPart(16)
invokeTag('textField','g',169,['type':("number"),'name':("otherAmt"),'required':(""),'value':(txnLoanCashSpecifiedRepaymentInstance?.otherAmt),'class':("form-control truncated"),'onchange':("updateVar()")],-1)
printHtmlPart(22)
...
public static final long LAST_MODIFIED = 1570673129521L
