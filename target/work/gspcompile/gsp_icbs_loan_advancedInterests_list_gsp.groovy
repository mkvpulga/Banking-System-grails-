...
printHtmlPart(2)
invokeTag('formatDate','g',18,['format':("MM-dd-yyyy"),'date':(eirSchedule?.transferDate)],-1)
printHtmlPart(3)
invokeTag('formatNumber','g',19,['number':(eirSchedule?.uidAmount),'format':("###,##0.00")],-1)
printHtmlPart(4)
i++
}
}
printHtmlPart(5)
invokeTag('formatNumber','g',32,['number':(totalUID),'format':("###,##0.00")],-1)
printHtmlPart(6)
}
...
public static final long LAST_MODIFIED = 1570673129036L
