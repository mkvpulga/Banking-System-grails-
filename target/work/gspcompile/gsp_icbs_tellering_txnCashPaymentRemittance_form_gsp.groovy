...
printHtmlPart(8)
invokeTag('render','g',49,['template':("/customer/details/txnCustomerDetails"),'model':([customerInstance:txnCashPaymentRemittanceInstance?.sender])],-1)
printHtmlPart(9)
if(true && (!txnCashPaymentRemittanceInstance?.beneficiary)) {
printHtmlPart(10)
}
printHtmlPart(11)
invokeTag('render','g',59,['template':("/customer/details/txnCustomerDetails"),'model':([customerInstance:txnCashPaymentRemittanceInstance?.beneficiary])],-1)
printHtmlPart(12)
expressionOut.print(hasErrors(bean: txnCashPaymentRemittanceInstance, field: 'txnAmt', 'has-error'))
printHtmlPart(13)
invokeTag('textField','g',65,['type':("number"),'name':("txnAmt"),'required':(""),'value':(txnCashPaymentRemittanceInstance?.txnAmt),'class':("form-control truncated"),'onkeyup':("updateVar()")],-1)
printHtmlPart(14)
expressionOut.print(hasErrors(bean: txnRemittanceInstance, field: 'controlNo', 'has-error'))
printHtmlPart(15)
invokeTag('message','g',70,['code':("txnRemittance.controlNo.label"),'default':("Control Number")],-1)
printHtmlPart(16)
invokeTag('textField','g',73,['name':("controlNo"),'value':(txnRemittanceInstance?.controlNo),'class':("form-control")],-1)
printHtmlPart(14)
expressionOut.print(hasErrors(bean: txnRemittanceInstance, field: 'txnParticulars', 'has-error'))
printHtmlPart(17)
invokeTag('message','g',78,['code':("txnRemittance.txnParticulars.label"),'default':("Particulars")],-1)
printHtmlPart(16)
invokeTag('textArea','g',81,['name':("txnParticulars"),'value':(txnRemittanceInstance?.txnParticulars),'class':("form-control")],-1)
printHtmlPart(14)
expressionOut.print(hasErrors(bean: txnCashReceiptRemittanceInstance, field: 'txnRef', 'has-error'))
printHtmlPart(18)
invokeTag('message','g',86,['code':("txnCashReceiptRemittance.txnRef.label"),'default':("Payout Instructions")],-1)
printHtmlPart(19)
invokeTag('textArea','g',88,['name':("txnRef"),'value':(txnCashReceiptRemittanceInstance?.txnRef),'class':("form-control")],-1)
printHtmlPart(20)
}
...
public static final long LAST_MODIFIED = 1570673129438L
