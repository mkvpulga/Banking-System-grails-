...
printHtmlPart(3)
invokeTag('field','g',107,['class':("form-control truncated"),'name':("amount"),'value':(fieldValue(bean: loanDeductionSchemeInstance, field: 'amount'))],-1)
printHtmlPart(4)
createTagBody(1, {->
printHtmlPart(5)
createTagBody(2, {->
...
printHtmlPart(28)
invokeTag('hiddenField','g',141,['name':("divisor"),'id':("divisor"),'value':("1")],-1)
printHtmlPart(29)
expressionOut.print(hasErrors(bean: loanDeductionSchemeInstance, field: 'hasEirMode', 'has-error'))
printHtmlPart(30)
invokeTag('message','g',146,['code':("loanDeductionScheme.hasEirMode.label"),'default':("EIR Mode")],-1)
printHtmlPart(21)
invokeTag('checkBox','g',150,['class':("form-control"),'name':("hasEirMode"),'value':(loanDeductionSchemeInstance?.hasEirMode)],-1)
printHtmlPart(11)
expressionOut.print(hasErrors(bean: loanDeductionSchemeInstance, field: 'contraAcct', 'has-error'))
printHtmlPart(31)
invokeTag('message','g',159,['code':("loanDeductionScheme.contraAcct.label"),'default':("GL Contra Account")],-1)
printHtmlPart(32)
invokeTag('select','g',164,['id':("contraAcct"),'name':("contraAcct.id"),'from':(icbs.gl.GlAccount.findAllByBranch(icbs.admin.Branch.get(1))),'optionKey':("id"),'optionValue':("name"),'value':(loanDeductionSchemeInstance?.contraAcct?.id),'noSelection':(['': '']),'class':("many-to-one form-control")],-1)
printHtmlPart(14)
createTagBody(1, {->
printHtmlPart(15)
createTagBody(2, {->
...
invokeTag('eachError','g',173,['bean':(loanDeductionSchemeInstance),'field':("contraAcct")],2)
printHtmlPart(18)
})
invokeTag('hasErrors','g',174,['bean':(loanDeductionSchemeInstance),'field':("contraAcct")],1)
printHtmlPart(33)
}
...
public static final long LAST_MODIFIED = 1570673129226L
