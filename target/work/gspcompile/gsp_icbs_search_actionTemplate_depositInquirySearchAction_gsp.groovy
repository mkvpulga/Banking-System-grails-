...
invokeTag('link','g',12,['class':("btn btn-secondary"),'controller':("deposit"),'action':("depositInquiry"),'params':([module:'']),'id':(depositInstance?.id),'onclick':("return confirm('Are you sure you want to query this Deposit Account?');")],2)
printHtmlPart(4)
}
else {
printHtmlPart(2)
...
public static final long LAST_MODIFIED = 1570673129347L
