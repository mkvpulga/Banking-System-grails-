...
createTagBody(3, {->
printHtmlPart(28)
invokeTag('hiddenField','g',114,['name':("version"),'value':(depositInstance?.version)],-1)
printHtmlPart(29)
invokeTag('render','g',116,['template':("form")],-1)
printHtmlPart(30)
})
invokeTag('form','g',118,['id':("saveDepositForm"),'url':([resource:depositInstance, action:'update']),'method':("PUT"),'onsubmit':("callLoadingDialog();")],3)
printHtmlPart(31)
})
...
public static final long LAST_MODIFIED = 1570673128311L
